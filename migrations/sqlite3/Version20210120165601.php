 ...
 */
final class Version20210120165601 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE manage (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, sharable_id INTEGER NOT NULL, created_at DATETIME NOT NULL, contactable BOOLEAN NOT NULL, confirmed BOOLEAN NOT NULL)');
        ...
        $this->addSql('CREATE TABLE sharable_contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, sharable_id INTEGER NOT NULL, created_at DATETIME NOT NULL, type VARCHAR(64) NOT NULL, content VARCHAR(255) NOT NULL, info CLOB DEFAULT NULL)');
        $this->addSql('CREATE INDEX IDX_67B095EDCADDAACF ON sharable_contact (sharable_id)');
        ...
        $this->addSql('CREATE TABLE user_class (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, next_id INTEGER DEFAULT NULL, rank SMALLINT NOT NULL, name VARCHAR(32) NOT NULL, share BOOLEAN NOT NULL, access BOOLEAN NOT NULL, can_invite BOOLEAN NOT NULL, max_paranoia SMALLINT NOT NULL, invite_frequency SMALLINT NOT NULL, share_score_req INTEGER NOT NULL, account_age_req INTEGER NOT NULL, validated_req INTEGER NOT NULL, verified_req BOOLEAN NOT NULL, created_at DATETIME NOT NULL, last_edited_at DATETIME NOT NULL)');
        ...
        $this->addSql('CREATE TABLE user_contact (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, disabled BOOLEAN NOT NULL, created_at DATETIME NOT NULL, type VARCHAR(64) NOT NULL, content VARCHAR(255) NOT NULL, info CLOB DEFAULT NULL)');
